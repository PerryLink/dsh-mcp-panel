...
- `tests/` — vitest; REAL `Context` + `Session`/`ToolRuntime`/`CommandRuntime` from the `0.1.7-rc.2` peers, fake Loader face, fake Agent, optional fake jobs.
