...
pnpm run typecheck:ci     # npm gate: published 0.1.7-rc.1 type faces, no checkout needed
pnpm test
pnpm run build
...
sources against the published `0.1.7-rc.1` faces and is what CI runs, so a PR
